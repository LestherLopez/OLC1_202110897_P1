...
SPACE   = [ \r\t\n]+
ENTER   = \r|\n|\r\n
COMENTARIO_MULTILINEA = "<!"[^CARACTER]~"!>"
COMENTARIO_SIMPLE = "//" .* 
CARACTERES_ESPECIALES = "\\\"" | "\\n" | "\\\'"
NOMBRE_VARIABLE= [0-9a-zA-Z_][a-zA-Z_]+
ESPECIALES_NOSALTADOS = [^\'\"]
CARACTER_ESPECIAL = \" {ESPECIALES_NOSALTADOS} \" | (CARACTERES_ESPECIALES)
%%
...
<YYINITIAL> {ESPECIALES_NOSALTADOS}  {System.out.println(yytext());   return new Symbol(sym.ESPECIALES_NOSALTADOS, yyline, yycolumn, yytext());  }
